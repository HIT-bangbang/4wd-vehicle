...
/*** OpenCRP驱动接口函数  M-Sensor运动传感器操作函数 **********/
...
//获取数据函数
float AX_MPU6050_GetTempValue(void);	//MPU6050获取传感器温度值
int16_t AX_MPU6050_GetAccData_X(void);    //MPU6050获取X轴加速度寄存器输出值
int16_t AX_MPU6050_GetAccData_Y(void);    //MPU6050获取Y轴加速度寄存器输出值
int16_t AX_MPU6050_GetAccData_Z(void);    //MPU6050获取Z轴加速度寄存器输出值
void AX_MPU6050_GetAccData(int16_t *pbuf);   //MPU6050获取三轴加速度寄存器输出值
int16_t AX_MPU6050_GetGyroData_X(void);   //MPU6050获取X轴陀螺仪寄存器输出值
int16_t AX_MPU6050_GetGyroData_Y(void);   //MPU6050获取Y轴陀螺仪寄存器输出值
int16_t AX_MPU6050_GetGyroData_Z(void);   //MPU6050获取Z轴陀螺仪寄存器输出值
